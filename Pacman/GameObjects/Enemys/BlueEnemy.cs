...
{
    internal class BlueEnemy : IEnemy
    {
        ...
        public BlueEnemy(Position position, IStrategy strategy, float baseSpeed = 100.0f, float speedMultiplier = 0.15f)
        {
            _images = new Dictionary<Direction, BitmapImage>
            {
                { Direction.Left, Properties.Resources.BlueLeft.ConvertToBitmapImage() },
                { Direction.Up, Properties.Resources.BlueUp.ConvertToBitmapImage() },
                { Direction.Right, Properties.Resources.BlueRight.ConvertToBitmapImage() },
                { Direction.Down, Properties.Resources.BlueDown.ConvertToBitmapImage() }
            };
